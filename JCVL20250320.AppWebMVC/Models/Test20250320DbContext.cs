...
public partial class Test20250320DbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__Brands__DAD4F3BE8F3CF467");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__Products__B40CC6ED9603ABF7");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC67E2BE0D");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534CD445D1E").IsUnique();
        ...
        {
            entity.HasKey(e => e.WarehouseId).HasName("PK__Warehous__2608AFD9C21FAF0F");
